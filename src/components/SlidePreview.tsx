...
const MinimalContent = ({ slide, styles, carousel, fontFam, titleScale, bodyScale, footerHandle, footerBranding, forceTextOnly }: TemplateProps) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", padding: "150px 80px 55px", overflow: "hidden", alignItems: "center", textAlign: "center" }}>
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", maxWidth: 900 }}>
        {/* Thin line accent */}
        <div style={{ width: 60, height: 3, background: styles.accent, marginBottom: 48, borderRadius: 999 }} />

        <h2 style={{ fontSize: (hasImg ? 52 : 72) * titleScale, fontWeight: 300, lineHeight: 1.15, color: styles.title, fontFamily: fontFam, letterSpacing: "-0.02em", WebkitLineClamp: 5, display: "-webkit-box", WebkitBoxOrient: "vertical", overflow: "hidden" }}>
          {slide.title}
        </h2>
